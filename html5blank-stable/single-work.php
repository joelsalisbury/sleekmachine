...
<?php if($menu){ ?>
    <div id="interior-jumbo" class="jumbotron <?php echo $color;?> clearfix">
	    <div class="container">
	    	<div class="row">
			    <div class="col-md-10 col-md-push-1 swiper-container" style="padding-left:0px; padding-right:0px;">
				...
				<div class="interior-page-content col-md-8 col-md-push-2">
					...
					<?php if (have_posts()): while (have_posts()) : the_post(); ?>
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
							<!-- post details -->
							<h3>
								<a href="http://joelsalisbury.com/projects/sleekmachine/dat-wp/work/">Work</a> | <strong><?php echo $client->name;?> </strong><?php the_title(); ?>
							</h3>
							<!-- /post details -->
